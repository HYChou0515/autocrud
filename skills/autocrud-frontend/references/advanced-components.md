...
Guide for extending and customizing the AutoCRUD frontend component system.
...
Every field in AutoCRUD is rendered through one of three context-specific layers:
