"""Tests for x-specstar-indexed-fields OpenAPI extension injection."""
...
def app_with_indexed_fields():
    ...
    spec.add_model(Schema(NoIndexModel, "v1"))
    spec.apply(app)
    spec.openapi(app)
    return app
...
def app_no_indexed_fields():
    ...
    spec = SpecStar()
    spec.add_model(Schema(Hero, "v1"))
    spec.add_model(Schema(Weapon, "v1"))
    spec.apply(app)
    spec.openapi(app)
    return app
...
class TestInjectIndexedFields:
    ...
    def test_indexed_fields_present_in_schema(self, app_with_indexed_fields):
        ...
        assert "x-specstar-indexed-fields" in schema
    ...
    def test_indexed_fields_mapping_content(self, app_with_indexed_fields):
        ...
        schema = app_with_indexed_fields.openapi_schema
        mapping = schema["x-specstar-indexed-fields"]
    ...
    def test_no_extension_when_no_indexed_fields(self, app_no_indexed_fields):
        ...
        assert "x-specstar-indexed-fields" not in schema
