...
class TestDiskPersistence:
    ...
    def test_disk_persistence_basic(self, temp_dir):
        ...
        # 創建一些產品
        products_data = [
            {"name": "筆記本電腦", "description": "高性能筆記本", "price": 25000.0, "category": "電子產品"},
            {"name": "無線滑鼠", "description": "高精度無線滑鼠", "price": 800.0, "category": "電子產品"},
            {"name": "咖啡豆", "description": "精品咖啡豆", "price": 450.0, "category": "食品"},
        ]
    ...
    def test_disk_persistence_updates(self, temp_dir):
        ...
        # 更新數據
        updated_product = crud1.update(product_id, {
            "name": "高端筆記本電腦",
            "description": "高端遊戲筆記本",
            "price": 30000.0,
            "category": "電子產品"
    ...
    def test_disk_persistence_deletions(self, temp_dir):
        ...
        product1 = crud1.create({"name": "產品1", "description": "測試產品1", "price": 100.0, "category": "測試"})
        crud1.create({"name": "產品2", "description": "測試產品2", "price": 200.0, "category": "測試"})
...
class TestSerializerPersistence:
    ...
    def test_different_serializers_persistence(self, temp_dir, serializer_type):
        """測試不同序列化器的持久化"""
        test_data = {"name": "測試產品", "description": "測試描述", "price": 100.0, "category": "測試"}
