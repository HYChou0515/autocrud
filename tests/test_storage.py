...
class TestMemoryStorage:
    ...
    def test_memory_storage_basic_operations(self, sample_product_data):
        ...
        # 更新
        updated_data = {"name": "更新產品", "description": "更新描述", "price": 999.0, "category": "測試"}
...
class TestDiskStorage:
    ...
    def test_disk_storage_with_different_serializers(self, temp_dir, sample_product_data):
        """測試磁碟存儲使用不同序列化器"""
...
class TestStorageComparison:
    ...
    def test_memory_vs_disk_performance(self, temp_dir, sample_product_data):
        ...
        memory_crud = AutoCRUD(model=Product, storage=memory_storage, resource_name="products")
        ...
        disk_crud = AutoCRUD(model=Product, storage=disk_storage, resource_name="products")
