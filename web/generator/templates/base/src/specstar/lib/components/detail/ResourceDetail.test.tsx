  ...
  it('shows back link pointing to job list for regular job resource', () => {
    ...
    render(
      <ResourceDetail
        config={config}
        resourceId="r1"
        basePath={'/specstar-admin/pet-job' as any}
        isJob={true}
      />,
      { wrapper: createWrapper() },
    );
    ...
    expect(backLink.getAttribute('data-to')).toBe('/specstar-admin/pet-job');
  });
  ...
  it('shows back link pointing to parent resource for async create job', () => {
    ...
    render(
      <ResourceDetail
        config={config}
        resourceId="r1"
        basePath={'/specstar-admin/new-char1-job' as any}
        isJob={true}
      />,
      { wrapper: createWrapper() },
    );
    ...
    expect(backLink.getAttribute('data-to')).toBe('/specstar-admin/character');
  });
});
