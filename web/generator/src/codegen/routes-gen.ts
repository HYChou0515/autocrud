...
function ListPage() {
  ...
  return (
    <Container size="xl" py="xl">
      <JobTable config={config} basePath="/autocrud-admin/${r.name}" />
    </Container>
  );
}
`;
  ...
  return (
    <Container size="xl" py="xl">
      <Stack gap="md">
        ...
        <ResourceTable config={config} basePath="/autocrud-admin/${r.name}" />
      </Stack>
    </Container>
  );
}
...
import { PendingUpdateJobsAccordion } from '../../../autocrud/lib/components/job/PendingUpdateJobsAccordion';
import { getResource } from '../../../autocrud/lib/resources';
