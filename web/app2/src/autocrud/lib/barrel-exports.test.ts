...
describe('barrel exports', () => {
  ...
  it('utils/formUtils/index.ts re-exports', async () => {
    const mod = await import('@/autocrud/lib/utils/formUtils/index');
