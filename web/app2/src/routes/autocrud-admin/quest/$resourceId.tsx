...
export const Route = createFileRoute('/autocrud-admin/quest/$resourceId')({
...
function DetailPage() {
  ...
  const navigate = useNavigate({ from: '/autocrud-admin/quest/$resourceId' });
