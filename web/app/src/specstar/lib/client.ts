 ...
 *
 * This is the path prefix under which all SpecStar endpoints live
 * (e.g. '/v1/specstar').  It is injected at startup via
 ...
 * include the base path (e.g. '/v1/specstar/blobs/...').
 */
 ...
 *
 * Returns the path prefix set via `setApiBasePath()` (e.g. '/v1/specstar').
 */
