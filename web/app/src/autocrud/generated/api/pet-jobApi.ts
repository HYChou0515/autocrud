...
export const petJobApi = {
  ...
  get: (id: string, params?: { revision_id?: string; partial?: string[]; returns?: string; include_deleted?: boolean }) =>
    client.get<FullResource<Job___main___Mount_____main___Dog__NoneType_>>(`${BASE}/${id}`, { params }),

  update: (id: string, data: Job___main___Mount_____main___Dog__NoneType_, params?: { change_status?: string; mode?: string }) =>
