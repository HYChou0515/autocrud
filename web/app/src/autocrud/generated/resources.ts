...
export type ResourceName = 'character' | 'guild' | 'skill' | 'equipment' | 'pet-job' | 'quest' | 'game-event' | 'new-char1-job' | 'create-new-character2-job' | 'create-new-character4-job' | 'pet';
...
export type QuestFieldName = 'title' | 'description' | 'level_requirement' | 'difficulty' | 'quest_config' | 'rewards';
export type GameEventFieldName = 'payload.event_type' | 'payload.character_name' | 'payload.character_id' | 'payload.description' | 'payload.reward_gold' | 'payload.reward_exp' | 'payload.extra_data' | 'payload.event_body' | 'payload.event_x.type' | 'payload.event_x.good' | 'payload.event_x.great' | 'payload.extra_values' | 'status' | 'errmsg' | 'artifact.process_times' | 'retries' | 'max_retries' | 'periodic_interval_seconds' | 'periodic_max_runs' | 'periodic_runs' | 'periodic_initial_delay_seconds' | 'last_heartbeat_at';
...
Object.assign(registry, {
  'character': {
    ...
    maxFormDepth: 1,
    indexedFields: ["level","name","gold","guild_name","character_class","guild_id","skill_ids"],
    customCreateActions: [
      {
  ...
  'quest': {
    ...
    rewards: z.array(z.discriminatedUnion('type', [z.object({ type: z.literal('QuestRewardItem'), item_name: z.string(), quantity: z.number().int().optional(), extra_properties: z.record(z.string(), z.any()).optional() }), z.object({ type: z.literal('QuestRewardGold'), amount: z.number().int().optional() }), z.object({ type: z.literal('QuestRewardExp'), exp: z.number().int().optional(), bonus_config: z.record(z.string(), z.any()).optional() })])).optional()
    }),
    apiClient: questApi,
    maxFormDepth: 1,
  ...
  'game-event': {
    ...
    defaultHiddenFields: ["status","errmsg","artifact.process_times","retries","max_retries","periodic_interval_seconds","periodic_max_runs","periodic_runs","periodic_initial_delay_seconds","last_heartbeat_at"],
    isJob: true,
  },
  'new-char1-job': {
    name: 'new-char1-job',
