...
export interface autocrud_resource_manager_pydantic_converter_Skill {
  skname: string;
  detail:
    | autocrud_resource_manager_pydantic_converter_ActiveSkillData
    | autocrud_resource_manager_pydantic_converter_PassiveSkillData
    | autocrud_resource_manager_pydantic_converter_UltimateSkillData;
  description?: string;
  required_level?: number;
  required_class?: CharacterClass | null;
}
