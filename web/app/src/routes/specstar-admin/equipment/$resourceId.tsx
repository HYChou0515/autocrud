...
export const Route = createFileRoute('/specstar-admin/equipment/$resourceId')({
...
function DetailPage() {
  ...
  const navigate = useNavigate({ from: '/specstar-admin/equipment/$resourceId' });
  ...
  return (
    <ResourceDetail
      ...
      basePath="/specstar-admin/equipment"
