...
export const Route = createFileRoute('/specstar-admin/pet-job/$resourceId')({
...
function DetailPage() {
  ...
  const navigate = useNavigate({ from: '/specstar-admin/pet-job/$resourceId' });
  ...
  return (
    <ResourceDetail
      ...
      basePath="/specstar-admin/pet-job"
      isJob={true}
