...
export const Route = createFileRoute('/specstar-admin/game-event/$resourceId')({
...
function DetailPage() {
  ...
  const navigate = useNavigate({ from: '/specstar-admin/game-event/$resourceId' });
  ...
  return (
    <ResourceDetail
      ...
      basePath="/specstar-admin/game-event"
      isJob={true}
