...
export const Route = createFileRoute('/specstar-admin/guild/$resourceId')({
...
function DetailPage() {
  ...
  const navigate = useNavigate({ from: '/specstar-admin/guild/$resourceId' });
