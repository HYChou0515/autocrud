...
|------|------|
| [＃建立](#create)|
| [`create(data, status=...)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.create)                                       | 建立新資源 |
| [＃讀取](#read)|
| [`get(resource_id)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.get)                                                  | 取得資源最新版本 |
| [`get_resource_revision(resource_id, revision_id)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.get_resource_revision) | 取得指定版本 |
| [`search_resources(query)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.search_resources)                              | 查詢資源（支援索引, 分頁, 排序）|
| [`count_resources(query)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.count_resources)                                | 計算資源數量 |
| [`list_revisions(resource_id)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.list_revisions)                            | 列出所有版本 |
| [＃更新](#update)|
| [`update(resource_id, data, status=...)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.update)                          | 全量更新資源，會產生新的 revision id（進版） |
| [`patch(resource_id, patch_data)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.patch)                                  | 套用 JSON Patch，會產生新 revision id（進版） |
| [`modify(resource_id, data/patch, status=...)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.modify)                    | 全量或局部更新，不會產生新 revision id（不進版），僅限資源狀態為 draft，狀態為 stable 時會失敗 |
| [`switch(resource_id, revision_id)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.switch)                               | 切換到指定版本 |
| [＃刪除](#delete) |
| [`delete(resource_id)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.delete)                                            | 軟刪除資源 |
| [`restore(resource_id)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.restore)                                          | 還原已刪除資源 |
| [＃管理](#management)|
| [`migrate(resource_id)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.migrate)                                          | 執行 schema 遷移 |
| [`dump()`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.dump)                                                           | 備份所有資源資料 |
| [`load(key, bio)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.load)                                                   | 還原資料 |
...
- [`create(data, status=...)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.create)：建立新資源，回傳`ResourceMeta`。
...
- [`get(resource_id, revision_id: str|UnsetType=UNSET)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.get)：取得資源最新版本。
...
- [`get_resource_revision(resource_id, revision_id)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.get_resource_revision)：取得指定版本內容。
...
- [`get_partial(resource_id, revision_id: str|UnsetType=UNSET, partial: list[str|JsonPointer])`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.get_partial)：取得資源的部分內容，支援巢狀欄位與 List Slicing。
...
- [`search_resources(query)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.search_resources)：依條件查詢資源（支援索引、分頁、排序）。
...
- [`count_resources(query)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.count_resources)：計算符合條件的資源數量。
...
- [`list_revisions(resource_id)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.list_revisions)：列出所有版本資訊。
...
- [`update(resource_id, data, status=...)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.update)：全量更新，進版。
...
- [`patch(resource_id, patch_data)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.patch)：套用 JSON Patch，進版。
...
- [`modify(resource_id, data/patch, status=...)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.modify)：不進版更新（僅 draft 可用）。
...
- [`migrate(resource_id)`](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager.migrate)：執行 schema migration。  
!!! seealso
...
| 欄位 | 說明 | 型別 |
|------|------|------|
| [`is_deleted`](../reference/types.md#autocrud.types.ResourceMetaSearchQuery.is_deleted)                  |資源是否被刪除                 | bool                                |
| [`created_time_start`](../reference/types.md#autocrud.types.ResourceMetaSearchQuery.created_time_start)  |在這之後建立（含）                   | datetime                    |
| [`created_time_end`](../reference/types.md#autocrud.types.ResourceMetaSearchQuery.created_time_end)      |在這之前建立（含）                   | datetime                      |
| [`updated_time_start`](../reference/types.md#autocrud.types.ResourceMetaSearchQuery.updated_time_start)  |在這之後修改（含）                   | datetime                    |
| [`updated_time_end`](../reference/types.md#autocrud.types.ResourceMetaSearchQuery.updated_time_end)      |在這之前修改（含）                   | datetime                      |
| [`created_bys`](../reference/types.md#autocrud.types.ResourceMetaSearchQuery.created_bys)                |誰建立                         | list[str]                          |
| [`updated_bys`](../reference/types.md#autocrud.types.ResourceMetaSearchQuery.updated_bys)                |誰更新                         | list[str]                          |
| [`conditions`](../reference/types.md#autocrud.types.ResourceMetaSearchQuery.conditions)                  |使用meta欄位或data的indexed fields搜尋 (see [General Filtering](#general-filtering-meta-data)) (**New in 0.6.9**) | list[DataSearchCondition or DataSearchGroup]                     |
| [`data_conditions`](../reference/types.md#autocrud.types.ResourceMetaSearchQuery.data_conditions)        |(Deprecated) 使用data的indexed fields搜尋 (see [Data Search Filter](#data-search-filter) and [data attribute index](#data-attribute-index))  | list[DataSearchCondition or DataSearchGroup]                     |
...
`DataSearchCondition`與`DataSearchGroup`可以提供基本的搜尋功能，詳細使用方式可以參考[DataSearchCondition](../reference/types.md#autocrud.types.DataSearchCondition)與[DataSearchGroup](../reference/types.md#autocrud.types.DataSearchGroup)
...
```
詳細使用方式可以參考[ResourceDataSearchSort](../reference/types.md#autocrud.types.ResourceDataSearchSort)與[ResourceMetaSearchSort](../reference/types.md#autocrud.types.ResourceMetaSearchSort)
...
```{eval-rst}
[RevisionInfo](../reference/types.md#autocrud.types.RevisionInfo)
   :members:
   :show-inheritance:
```

```{eval-rst}
[ResourceManager](../reference/resource_manager/core.md#autocrud.resource_manager.core.ResourceManager)
   :members:
   :no-undoc-members:
   :show-inheritance:
```
...
```{eval-rst}
[ResourceMetaSearchQuery](../reference/types.md#autocrud.types.ResourceMetaSearchQuery)
   :members:
   :no-undoc-members:
   :show-inheritance:
```
...
```{eval-rst}
[DataSearchCondition](../reference/types.md#autocrud.types.DataSearchCondition)
   :members:
[DataSearchGroup](../reference/types.md#autocrud.types.DataSearchGroup)
   :members:
[DataSearchLogicOperator](../reference/types.md#autocrud.types.DataSearchLogicOperator)
   :members:
[DataSearchOperator](../reference/types.md#autocrud.types.DataSearchOperator)
   :members:
```

```{eval-rst}
[ResourceMetaSearchSort](../reference/types.md#autocrud.types.ResourceMetaSearchSort)
   :members:
[ResourceDataSearchSort](../reference/types.md#autocrud.types.ResourceDataSearchSort)
   :members:
[ResourceMetaSortKey](../reference/types.md#autocrud.types.ResourceMetaSortKey)
   :members:
[ResourceMetaSortDirection](../reference/types.md#autocrud.types.ResourceMetaSortDirection)
   :members:
```