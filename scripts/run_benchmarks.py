...
def update_docs():
    ...
    if res_md.exists():
        ...
        text = re.sub(r"^# Resource Store Benchmark Results", "#### Resource Store", text, flags=re.MULTILINE)
    ...
    if meta_md.exists():
        ...
        text = re.sub(r"^# MetaStore Benchmark Results", "#### Meta Store", text, flags=re.MULTILINE)
        text = re.sub(r"^### ", "##### ", text, flags=re.MULTILINE)
    ...
    # Markers
    start_marker = "### 📊 Performance Benchmark"
    end_marker = "## 🔒 進階功能"
