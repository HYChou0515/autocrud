...
from autocrud.resource_manager.permission import PermissionResourceManager, Permission, Effect
from autocrud.resource_manager.permission_context import DefaultPermissionChecker
from autocrud.resource_manager.permission_utils import PermissionBuilder, CommonPermissions
...
def test_improved_permission_setup():
    ...
    with permission_manager.meta_provide(admin_user, current_time):
        ...
        permissions = [
            ...
            PermissionBuilder.allow_user_on_resource_type("alice", "test_document", "create"),
            PermissionBuilder.allow_user_on_resource_type("alice", "test_document", "get"),
            PermissionBuilder.allow_user_on_resource_type("alice", "test_document", "get_meta"),
            PermissionBuilder.allow_user_on_resource_type("alice", "test_document", "get_resource_revision"),
            PermissionBuilder.allow_user_on_resource_type("alice", "test_document", "search_resources"),
        ...
        read_only_permissions = CommonPermissions.read_only_for_user("bob", "test_document")
...
def test_permission_hierarchy():
    ...
    with permission_manager.meta_provide(admin_user, current_time):
        ...
        permissions = [
            ...
            # 2. 中等：對資源類型的權限
            PermissionBuilder.allow_user_on_resource_type("bob", "test_document", "get"),
