...
accumulated log lines from a :class:`~specstar.message_queue.context.JobContext`
to a :class:`~specstar.resource_manager.basic.IBlobStore`.  The structure
mirrors :class:`~specstar.message_queue.heartbeat.HeartbeatThread`.
"""
