...
from autocrud.crud.ref_manager import install_ref_integrity_handlers
...
from autocrud.events import IEventHandler
...
class AutoCRUD:
    ...
    def openapi(self, app: FastAPI, structs: list[type] = None) -> None:
        ...
        """
        from autocrud.crud.openapi_builder import OpenAPIBuilder
    ...
    def _register_async_job_models(self) -> None:
        from autocrud.crud.async_jobs import register_async_create_jobs
    ...
    def _register_async_update_job_models(self) -> None:
        from autocrud.crud.async_jobs import register_async_update_jobs
